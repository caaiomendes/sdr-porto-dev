...
$localIp = getRealUserIp(); 
//echo $localIp;

$serverIP = '154.12.229.119';

//var_dump('serverIp... ' . $serverIp );
//var_dump( ($serverIp) == "207.244.229.206" );

if($localIp != $serverIP){
     die('Identificando IP... ' . $localIp);	
}
...
$api = new PHP_CRUD_API(array(
	'dbengine'=>'MySQL',
	'hostname'=>'sdrporto.com.br',
	'username'=>'sdrporto_homologador',
	'password'=>'aiVrkR9ER1y6@444JGq&',
	'database'=>'sdrporto_homologacao',
	'charset'=>'utf8'
));
$api->executeCommand();