...
function ArquivoService ($http) {
    return {
        ...
        getAll : function () {
            return $http({
                method : "GET",
                url : GLOBAL.barramentoGenericov2 + "/arquivo" + "?transform=1"
            })
        },
        ...
        getOne : function (id) {
            return $http({
                method : "GET",
                url : GLOBAL.barramentoGenericov2 + "/arquivo/" + id + "?transform=1",
            })
        },
        ...
        getAllByPacienteID : function (id) {
            return $http({
                method : "GET",
                url : GLOBAL.barramentoGenericov2 + "/arquivo?filter=pacienteID,eq," + id + "&transform=1",
            })
        },
        ...
        update : function (objeto) {
            return $http({
                method : "PUT",
                url : GLOBAL.barramentoGenericov2 + "/arquivo/" + objeto.id + "?transform=1",
                data: objeto
            })
        },
